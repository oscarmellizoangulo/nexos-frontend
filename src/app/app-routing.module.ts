...
import { LoginPage } from './pages/nexos/security/login.page';
import { HomePage } from './pages/nexos/home/home';


const routes: Routes = [
  { path: '', redirectTo: '/nexos/security/login', pathMatch: 'full' },

  { path: 'nexos/security/login', component: LoginPage, data: { title: 'Autenticación'} },
  { path: 'nexos/home/home', component: HomePage, data: { title: 'Home'} },
