...
import { Component, Input, Output, EventEmitter, ElementRef, HostListener, ViewChild, OnInit, AfterViewChecked, Inject } 		 from '@angular/core';
...
export class SidebarComponent implements AfterViewChecked {
  ...
  user:any;
  constructor(private eRef: ElementRef, @Inject(SESSION_STORAGE) private storage: WebStorageService, private router: Router ) {
    if (window.innerWidth <= 767) {
      this.mobileMode = true;
      this.desktopMode = false;
    } else {
